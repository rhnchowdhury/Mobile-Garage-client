...
const Banner = () => {
    ...
    return (
        <div className="carousel w-full bg-slate-300 rounded-xl">
                ...
                <div className="hero">
                    <div className="hero-content flex-col gap-20 lg:flex-row-reverse">
                        ...
                        <div className='mr-20'>
                            ...
                            <button className="btn btn-secondary mt-4">Explore Now</button>
                        </div>
                    </div>
                ...
                <div className="hero">
                    <div className="hero-content flex-col gap-20 lg:flex-row-reverse">
                        ...
                        <div className='mr-28'>
                            ...
                            <button className="btn btn-secondary mt-4">Sell Now</button>
                        </div>
                    </div>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">

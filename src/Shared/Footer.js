...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-stone-500 text-base-content">
            <div>
                <p className='text-white'>Copyright © 2022 - All right reserved<br />Providing reliable service since 2000</p>
            </div>
            <div>
